...
class Instances:
    ...
    def __getitem__(self, index: int | np.ndarray | slice) -> Instances:
        ...
        points_3d = self.points_3d[index] if self.points_3d is not None else None
    ...
    def remove_zero_area_boxes(self) -> np.ndarray:
        ...
        if not all(good):
            ...
            if self.points_3d is not None:
                self.points_3d = self.points_3d[good]
        return good

    def update(self, bboxes: np.ndarray, segments: np.ndarray = None, keypoints: np.ndarray = None, points_3d: np.ndarray = None):
    ...
    def concatenate(cls, instances_list: list[Instances], axis=0) -> Instances:
        ...
        use_points_3d = instances_list[0].points_3d is not None
        ...
        cat_points_3d = np.concatenate([b.points_3d for b in instances_list], axis=axis) if use_points_3d else None
        return cls(cat_boxes, cat_segments, cat_keypoints, cat_points_3d, bbox_format, normalized)
